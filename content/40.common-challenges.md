...
<table class="tg">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> Multi-block PCA [@doi:10.18129/B9.bioc.mogsa]<br> Weighting matrices based on their similarities: STATIS, MFA (Chen*)(bulk)<br> Scale MIBI-TOF to the range of CyTOF values (Jeganathan) </td>
    ...
    <tr>
      ...
      <td></td>
      <td> Topic modeling to predict cell spatial co-location or spatial expression (Jeganathan)<br>
      </td>
      <td></td>
    </tr>
    <tr>
